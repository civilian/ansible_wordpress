...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'the-dylan' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'the-dylan' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'the-dylan' ),
		'cyrillic'     => __( 'Cyrillic', 'the-dylan' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'the-dylan' ),
		'devanagari'   => __( 'Devanagari', 'the-dylan' ),
		'greek'        => __( 'Greek', 'the-dylan' ),
		'greek-ext'    => __( 'Greek Extended', 'the-dylan' ),
		'khmer'        => __( 'Khmer', 'the-dylan' ),
		'latin'        => __( 'Latin', 'the-dylan' ),
		'latin-ext'    => __( 'Latin Extended', 'the-dylan' ),
		'vietnamese'   => __( 'Vietnamese', 'the-dylan' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'the-dylan' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'the-dylan' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'the-dylan' ),
